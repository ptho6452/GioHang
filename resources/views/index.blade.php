                                    ...
                                    <div class="select-button">
                                        <a href="{{ url('List-Carts') }}" class="primary-btn view-card">VIEW CARD</a>
                                          ...
                                          <form action={{ url('/momo_payment') }} method="post">
                                            ...
                                            <button type="submit"  name="payUrl" class="primary-btn checkout-btn" style="width:100%">Thanh Toán Bằng momo</button>
                                            </form>
                                    </div>
                                </div>
                            </li>
...
<link rel="stylesheet" href="//cdn.jsdelivr.net/npm/alertifyjs@1.13.1/build/css/themes/bootstrap.min.css"/>
  ...
  const $changeItemCart = $("#change-item-cart");
  const $totalQuantyShow = $("#total-quanty-show");
  const $totalQuantyCart = $("#total-quanty-cart");

  $changeItemCart.empty().html(response);
  $totalQuantyShow.val($totalQuantyCart.val());
}
    </script>
</body>
